# PeerplaysJS (peerplayjs-lib)

Pure JavaScript Peerplays library for node.js and browsers. Can be used to construct, sign and broadcast transactions in JavaScript, and to easily obtain data from the blockchain via public apis.

...
ChainTypes.impl_object_type = {
    ...
    witness_schedule: 12,
    budget_record: 13,
    betting_market_position: 14,
    global_betting_statistics: 15
};
...
ChainTypes.operations = {
    ...
    asset_claim_fees: 43,
    sport_create: 45,
    competitor_create: 46,
    event_group_create: 47,
    event_create: 48,
    betting_market_group_create: 49,
    betting_market_create: 50,
    bet_place: 51,
    betting_market_resolve: 52,
    betting_market_resolved: 53,
    bet_matched: 54,
    bet_cancel: 55,
    bet_canceled: 56
};

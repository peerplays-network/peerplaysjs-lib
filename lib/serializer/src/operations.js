...
const vesting_balance_type = enumeration([ 'normal', 'gpos' ]);
...
const offer_operation = new Serializer('offer_operation', {
...
const bid_operation = new Serializer('bid_operation', {
  fee: asset,
...
const finalize_offer_operation = new Serializer('finalize_offer_operation', {
  fee: asset,
  fee_paying_account: protocol_id_type('account'),
  offer_id: protocol_id_type('offer'),
  result: result_type,
...
const nft_metadata_create_operation = new Serializer('nft_metadata_create_operation', {
  fee: asset,
  owner: protocol_id_type('account'),
  name: string,
  symbol: string,
...
const nft_metadata_update_operation = new Serializer('nft_metadata_update_operation', {
  fee: asset,
  owner: protocol_id_type('account'),
...
const nft_mint_operation = new Serializer('nft_mint_operation', {
  fee: asset,
  payer: protocol_id_type('account'),
...
const nft_safe_transfer_from_operation = new Serializer('nft_safe_transfer_from_operation', {
  fee: asset,
...
const nft_approve_operation = new Serializer('nft_approve_operation', {
  fee: asset,
  operator_: protocol_id_type('account'),
  approved: protocol_id_type('account'),
  token_id: protocol_id_type('nft')
...
const nft_set_approval_for_all_operation = new Serializer('nft_set_approval_for_all_operation', {
  fee: asset,
  owner: protocol_id_type('account'),
  operator_: protocol_id_type('account'),
  approved: bool

...
const nft_create_operation_fee_parameters = new Serializer(
  'nft_create_operation_fee_parameters',
  {
    fee: uint64
  }
);
...
const nft_create_operation = new Serializer('nft_create_operation', {
  fee: asset,
  owner: protocol_id_type('account'),

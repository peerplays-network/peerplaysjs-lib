  ...
  _createClass(ChainWebSocket, [{
    ...
    value: function resetConnection() {
      ...
      if (this.currentReject) {
        this.currentReject(new Error("Connection attempt failed: ".concat(this.serverAddress)));
      }
    }
    /**
    ...
    key: "createConnectionPromise",
    value: function createConnectionPromise(resolve, reject) {
    ...
    key: "onConnectionTimeout",
    value: function onConnectionTimeout() {
    ...
    key: "onConnectionTerminate",
    value: function onConnectionTerminate() {
    ...
    value: function onConnectionClose(error) {
    ...
    value: function onConnectionError(error) {
    ...
    value: function listener(response) {
      ...
      try {
        ...
        responseJSON.error = "Error parsing response: ".concat(error.stack);

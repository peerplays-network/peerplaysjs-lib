...
var key = {
  ...
  /**
    ...
    */
  random32ByteBuffer: function random32ByteBuffer(entropy) {
    if (entropy === void 0) {
  ...
  suggest_brain_key: function suggest_brain_key(dictionary, entropy) {
  ...
  get_brainPrivateKey: function get_brainPrivateKey(brainKey, sequence) {
    if (sequence === void 0) {
      sequence = 0;
    }
    ...
    return _PrivateKey["default"].fromBuffer((0, _hash.sha256)((0, _hash.sha512)(brainKey + " " + sequence)));
  },
  ...
  addresses: function addresses(pubkey, address_prefix) {

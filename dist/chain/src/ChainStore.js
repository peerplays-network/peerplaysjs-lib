...
var emitter = _EmitterInstance["default"].emitter();
...
var order_prefix = "1.".concat(limit_order, ".");
var call_order_prefix = "1.".concat(call_order, ".");
var proposal_prefix = "1.".concat(proposal, ".");
var operation_history_prefix = "1.".concat(op_history, ".");
var balance_prefix = "2.".concat(parseInt(impl_object_type.account_balance, 10), ".");
var account_stats_prefix = "2.".concat(parseInt(impl_object_type.account_statistics, 10), ".");
var transaction_prefix = "2.".concat(parseInt(impl_object_type.transaction, 10), ".");
var account_transaction_history_prefix = "2.".concat(parseInt(impl_object_type.account_transaction_history, 10), ".");
var asset_dynamic_data_prefix = "2.".concat(parseInt(impl_object_type.asset_dynamic_data, 10), ".");
var bitasset_data_prefix = "2.".concat(parseInt(impl_object_type.asset_bitasset_data, 10), ".");
var block_summary_prefix = "2.".concat(parseInt(impl_object_type.block_summary, 10), ".");
/* eslint-disable no-unused-vars */

var vesting_balance_prefix = "1.".concat(vesting_balance_type, ".");
/* eslint-enable no-unused-vars */

var witness_prefix = "1.".concat(witness_object_type, ".");
var worker_prefix = "1.".concat(worker_object_type, ".");
var committee_prefix = "1.".concat(committee_member_object_type, ".");
var asset_prefix = "1.".concat(asset_object_type, ".");
var account_prefix = "1.".concat(account_object_type, ".");
var tournament_prefix = "1.".concat(tournament_object_type, ".");
var tournament_details_prefix = "1.".concat(tournament_details_object_type, "."); // count last operations should be stored in memory

var operations_stack_size = 100; // count last blocks should be stored in memory
...
var ChainStore = /*#__PURE__*/function () {
  function ChainStore() {
    ...
    this.clearCache();
    this.progress = 0; // this.chain_time_offset is used to estimate the blockchain time
  ...
  _createClass(ChainStore, [{
    ...
    value: function clearCache() {
      this.objects_by_id = _immutable["default"].Map();
      this.accounts_by_name = _immutable["default"].Map();
      this.assets_by_symbol = _immutable["default"].Map();
      this.account_ids_by_key = _immutable["default"].Map();
      this.balance_objects_by_address = _immutable["default"].Map();
      this.get_account_refs_of_keys_calls = _immutable["default"].Set();
      this.event_groups_list_by_sport_id = _immutable["default"].Map();
      this.betting_market_groups_list_by_sport_id = _immutable["default"].Map();
      this.betting_markets_list_by_sport_id = _immutable["default"].Map();
      this.account_history_requests = new Map(); // /< tracks pending history requests

      this.witness_by_account_id = new Map();
      this.witnesses = _immutable["default"].Set();
      ...
      this.recent_operations = _immutable["default"].List();
      this.recent_blocks = _immutable["default"].List();
      this.recent_blocks_by_id = _immutable["default"].Map();
      this.last_processed_block = null;
      this.simple_objects_by_id = _immutable["default"].Map();
      this.lotteries_ids = _immutable["default"].List();
      this.lotteries_ids_initialized = false;
      clearTimeout(this.timeout); // tournament_ids_by_state is a
      ...
      this.tournament_ids_by_state = _immutable["default"].Map().set(null, new _immutable["default"].Map()); // registered_tournaments_details_by_player is a map of
      ...
      this.registered_tournament_ids_by_player = _immutable["default"].Map();
        ...
        return db_api.exec('get_objects', [['2.1.0']]).then(function (optional_objects) {
          for (var i = 0, len = optional_objects.length; i < len; i++) {
            ...
            if (optional_object) {
              ...
              var head_time = new Date("".concat(optional_object.time, "+00:00")).getTime();
    ...
    key: "_subTo",
    value: function _subTo(type, id) {
      var key = "subbed_".concat(type);
    ...
    key: "unSubFrom",
    value: function unSubFrom(type, id) {
      var key = "subbed_".concat(type);
      this[key]["delete"](id);
    ...
    key: "_isSubbedTo",
    value: function _isSubbedTo(type, id) {
      var key = "subbed_".concat(type);
    ...
    key: "onUpdate",
    value: function onUpdate(updated_objects) {
      var cancelledOrders = [];
      var closedCallOrders = [];
      emitter.emit('heartbeat'); // updated_objects is the parameter list, it should always be exactly
      // one element long.
    ...
    value: function getObject(id) {
      ...
      if (!_ChainValidation["default"].is_object_id(id)) {
        throw Error("argument is not an object id: ".concat(JSON.stringify(id)));
      }
    ...
    value: function getSimpleObjectById(id) {
      ...
      return new Promise(function (success, fail) {
        if (!_ChainValidation["default"].is_object_id(id)) {
          return fail(new Error("argument is not an object id: ".concat(JSON.stringify(id))));
        }
    ...
    value: function getBalanceObjects(address) {
      ...
      if (current === undefined) {
         ...
         */
        this.balance_objects_by_address = this.balance_objects_by_address.set(address, _immutable["default"].Set());
        ...
        _ws.Apis.instance().db_api().exec('get_balance_objects', [[address]]).then(function (balance_objects) {
          ...
          _this6.balance_objects_by_address = _this6.balance_objects_by_address.set(address, _immutable["default"].Set(set));
    ...
    value: function getTournamentIdsInState(accountId, stateString) {
      ...
      var tournamentIdsForThisAccountAndState;
      var tournamentIdsForThisAccount = this.tournament_ids_by_state.get(accountId);

      if (tournamentIdsForThisAccount === undefined) {
        tournamentIdsForThisAccountAndState = new _immutable["default"].Set();
        tournamentIdsForThisAccount = new _immutable["default"].Map().set(stateString, tournamentIdsForThisAccountAndState);
      ...
      _ws.Apis.instance().db_api().exec('get_tournaments_in_state', [stateString, 100]).then(function (tournaments) {
        var originalTournamentIdsInState = _this7.tournament_ids_by_state.getIn([accountId, stateString]); // call updateObject on each tournament, which will classify it
    ...
    value: function getRegisteredTournamentIds(accountId) {
      ...
      tournamentIds = new _immutable["default"].Set();
      ...
      _ws.Apis.instance().db_api().exec('get_registered_tournaments', [accountId, 100]).then(function (registered_tournaments) {
        ...
        var newTournamentIds = new _immutable["default"].Set(registered_tournaments);
    ...
    value: function fetchObject(id) {
      ...
      if (!_ChainValidation["default"].is_object_id(id)) {
        throw Error("argument is not an object id: ".concat(id));
      }
    ...
    value: function getAccount(name_or_id) {
      ...
      if (_ChainValidation["default"].is_account_name(name_or_id, true)) {
    ...
    value: function getCommitteeMember(id_or_account) {
      ...
      var is_account = _ChainValidation["default"].is_account_name(id_or_account, true);
      ...
      if (is_account || id_or_account.substring(0, 4) === '1.2.') {
        ...
        if (!account) {
          this.lookupAccountByName(id_or_account).then(function (lookup_account) {
            ...
            if (_ChainValidation["default"].is_object_id(committee_id)) {
    ...
    value: function fetchFullAccount(name_or_id) {
      ...
      if (_ChainValidation["default"].is_object_id(name_or_id)) {
        ...
        if (!_ChainValidation["default"].is_account_name(name_or_id, true)) {
          throw Error("argument is not an account name: ".concat(name_or_id));
        }

        var account_id = this.accounts_by_name.get(name_or_id);

        if (_ChainValidation["default"].is_object_id(account_id)) {
      ...
      if (!this.fetching_get_full_accounts.has(name_or_id) || Date.now() - this.fetching_get_full_accounts.get(name_or_id) > 5000) {
        this.fetching_get_full_accounts.set(name_or_id, Date.now()); // console.log( "FETCHING FULL ACCOUNT: ", name_or_id )
        ...
        _ws.Apis.instance().db_api().exec('get_full_accounts', [[name_or_id], true]).then(function (results) {
          ...
          account.pending_dividend_payments = new _immutable["default"].Set();
    ...
    value: function fetchRecentHistory(account) {
      ...
      if (!_ChainValidation["default"].is_object_id(account_id) && account.toJS) {
      ...
      var most_recent = "1.".concat(op_history, ".0");
      ...
      var start = "1.".concat(op_history, ".0");
      pending_request.promise = new Promise(function (resolve, reject) {
        _ws.Apis.instance().history_api().exec('get_account_history', [account_id, most_recent, limit, start]).then(function (operations) {
          ...
          if (!current_history) {
            current_history = _immutable["default"].List();
          }
    ...
    function getEventGroupsList(sportId) {
      ...
      if (eventGroupsList === undefined) {
        ...
        _ws.Apis.instance().db_api().exec('list_event_groups', [sportId]).then(function (eventGroups) {
          ...
          _this17.event_groups_list_by_sport_id = _this17.event_groups_list_by_sport_id.set(sportId, _immutable["default"].Set(set));
    ...
    key: "getBettingMarketGroupsList",
    value: function getBettingMarketGroupsList(eventId) {
      var _this18 = this;

      var bettingMarketGroupsList = this.betting_market_groups_list_by_sport_id.get(eventId);

      if (bettingMarketGroupsList === undefined) {
        this.betting_market_groups_list_by_sport_id = this.betting_market_groups_list_by_sport_id.set(eventId, _immutable["default"].Set());
        ...
        _ws.Apis.instance().db_api().exec('list_betting_market_groups', [eventId]).then(function (bettingMarketGroups) {
          ...
          eventId, _immutable["default"].Set(set));
    ...
    key: "getBettingMarketsList",
    value: function getBettingMarketsList(bettingMarketGroupId) {
      var _this19 = this;

      var bettingMarketsList = this.betting_markets_list_by_sport_id.get(bettingMarketGroupId);

      if (bettingMarketsList === undefined) {
        this.betting_markets_list_by_sport_id = this.betting_markets_list_by_sport_id.set(bettingMarketGroupId, _immutable["default"].Set());
        ...
        _ws.Apis.instance().db_api().exec('list_betting_markets', [bettingMarketGroupId]).then(function (bettingMarkets) {
          ...
          _this19.betting_markets_list_by_sport_id = _this19.betting_markets_list_by_sport_id.set(bettingMarketGroupId, _immutable["default"].Set(set));
    ...
    function _updateObject(object) {
      ...
      */
      ...
      if (current === undefined || current === true) {
        this.objects_by_id = this.objects_by_id.set(object.id, current = _immutable["default"].fromJS(object));
      } else {
        this.objects_by_id = this.objects_by_id.set(object.id, current = current.mergeDeep(_immutable["default"].fromJS(object)));
      } // BALANCE OBJECT
      ...
      if (objectSpace === balance_prefix) {
        ...
        if (!balances) {
          owner = owner.set('balances', _immutable["default"].Map());
        }
        ...
        current = current.set('pending_dividend_payments', _immutable["default"].fromJS(object.pending_dividend_payments));
        ...
        if (account && account.has('call_orders')) {
          ...
          if (!call_orders.has(object.id)) {
            ...
            this.objects_by_id = this.objects_by_id.set(account.get('id'), account); // Force subscription to the object in the witness node by calling get_objects
        ...
        if (_account2 && _account2.has('orders')) {
          ...
          if (!limit_orders.has(object.id)) {
            ...
            this.objects_by_id = this.objects_by_id.set(_account2.get('id'), _account2); // Force subscription to the object in the witness node by calling get_objects
        ...
        if (priorRegisteredPlayers !== newRegisteredPlayers) {
          this.registered_tournament_ids_by_player = this.registered_tournament_ids_by_player.map(function (tournamentIdsSet, accountId) {
            ...
            return tournamentIdsSet; // currently, you can't un-register for a tournament, so we don't have
    ...
    value: function getTournaments(last_tournament_id) {
      ...
      var start_tournament_id = arguments.length > 2 ? arguments[2] : undefined;
    ...
    value: function getLastTournamentId() {
      ...
      return new Promise(function (resolve) {
        if (_this21.last_tournament_id === undefined) {
          _ws.Apis.instance().db_api().exec('get_tournaments', ["".concat(tournament_prefix, "0"), 1, "".concat(tournament_prefix, "0")]).then(function (tournaments) {
        ...
        _ws.Apis.instance().db_api().exec('lookup_vote_ids', [missing]).then(function (vote_obj_array) {
          for (var _i2 = 0; _i2 < vote_obj_array.length; ++_i2) {
            if (vote_obj_array[_i2]) {
              ...
              var immutableMapConvert = _immutable["default"].fromJS(vote_obj_array[_i2]);
    ...
    key: "getLastIdLottery",
    value: function getLastIdLottery() {
    ...
    key: "getAllLotteriesIds",
    value: function getAllLotteriesIds() {
      var _this27 = this;
          ...
          var fetchLotteries = function fetchLotteries(prevId, limit, nextId, isLastRequest) {
            ...
            return _ws.Apis.instance().db_api().exec('get_lotteries', [prevId, limit, nextId]).then(function (lotteries) {
              ...
              var firstId = lotteries[0]['id'],
                  ...
                  nextNumId = firstIdNum - limit; // eslint-disable-next-line max-len
    ...
    key: "getGlobalBettingStatistics",
    value: function getGlobalBettingStatistics() {
      return new Promise(function (resolve, reject) {
    ...
    key: "getBinnedOrderBook",
    value: function getBinnedOrderBook(betting_market_id, precision) {
      return new Promise(function (resolve, reject) {
    ...
    key: "getTotalMatchedBetAmountForBettingMarketGroup",
    value: function getTotalMatchedBetAmountForBettingMarketGroup(group_id) {
      return new Promise(function (resolve, reject) {
    ...
    key: "getEventsContainingSubString",
    value: function getEventsContainingSubString(sub_string, language) {
      return new Promise(function (resolve, reject) {
    ...
    key: "getUnmatchedBetsForBettor",
    value: function getUnmatchedBetsForBettor(betting_market_id_type, account_id_type) {
      return new Promise(function (resolve, reject) {
    ...
    key: "listEventsInGroup",
    value: function listEventsInGroup(event_group_id) {
      return new Promise(function (resolve, reject) {
    ...
    key: "getAllUnmatchedBetsForBettor",
    value: function getAllUnmatchedBetsForBettor(account_id_type) {
      return new Promise(function (resolve, reject) {
    ...
    key: "getMatchedBetsForBettor",
    value: function getMatchedBetsForBettor(bettor_id) {
      return new Promise(function (resolve, reject) {
    ...
    key: "getAllMatchedBetsForBettor",
    value: function getAllMatchedBetsForBettor(bettor_id, start) {
...
function FetchChain(methodName, objectIds) {
  ...
  if (!method) {
    throw new Error("ChainStore does not have method ".concat(methodName));
  }
  ...
  return chain_store.FetchChainObjects(method, _immutable["default"].List(objectIds), timeout).then(function (res) {

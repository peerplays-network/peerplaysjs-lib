...
var tournament_details_prefix = "1." + tournament_details_object_type + "."; // count last operations should be stored in memory
...
var ChainStore = /*#__PURE__*/function () {
  ...
  _proto.onUpdate = function onUpdate(updated_objects) {
    var cancelledOrders = [];
  ...
  _proto.getObject = function getObject(id, force) {
    if (force === void 0) {
      force = false;
    }
  ...
  _proto.getSimpleObjectById = function getSimpleObjectById(id) {
    var _this3 = this;
  ...
  _proto.getTournamentIdsInState = function getTournamentIdsInState(accountId, stateString) {
    var _this7 = this;
  ...
  _proto.getRegisteredTournamentIds = function getRegisteredTournamentIds(accountId) {
    var _this8 = this;
  ...
  _proto.fetchObject = function fetchObject(id, force) {
    var _this9 = this;
  ...
  _proto.getAccount = function getAccount(name_or_id) {
    if (!name_or_id) {
      return null;
    }
  ...
  _proto.getWitnessAccount = function getWitnessAccount(witness_id) {
    var _this10 = this;
  ...
  _proto.getWitness = function getWitness(id_or_account) {
  ...
  _proto.getCommitteeMember = function getCommitteeMember(id_or_account, on_update) {
    var _this11 = this;
  ...
  _proto.fetchWitnessAccounts = function fetchWitnessAccounts() {
    var _this12 = this;
  ...
  _proto.fetchFullAccount = function fetchFullAccount(name_or_id) {
    var _this15 = this;
  ...
  _proto.getEventGroupsList = function getEventGroupsList(sportId) {
    var _this17 = this;
  ...
  _proto.getBettingMarketGroupsList = function getBettingMarketGroupsList(eventId) {
    var _this18 = this;
  ...
  _proto.getBettingMarketsList = function getBettingMarketsList(bettingMarketGroupId) {
    var _this19 = this;
  ...
  ChainStore.getAllMatchedBetsForBettor = function getAllMatchedBetsForBettor(bettor_id, start, limit) {
    if (limit === void 0) {
      limit = 1000;
    }
  ...
  _proto.setLastTournamentId = function setLastTournamentId(current_tournament_id) {
  ...
  _proto.getTournaments = function getTournaments(last_tournament_id, limit, start_tournament_id) {
    var _this20 = this;
  ...
  _proto.getLastTournamentId = function getLastTournamentId() {
    var _this21 = this;
  ...
  _proto.__getBlocksForScan = function __getBlocksForScan(lastBlock) {
    var _this24 = this;
  ...
  _proto.__bindBlock = function __bindBlock(lastBlock, scanToBlock, isInit) {
    var _this25 = this;
  ...
  _proto.fetchRecentOperations = function fetchRecentOperations(lastBlock) {
    var _this26 = this;
  ...
  _proto.getRecentBlocks = function getRecentBlocks() {
    return this.recent_blocks;
  };

  _proto.getRecentOperations = function getRecentOperations() {
  ...
  _proto.getLastIdLottery = function getLastIdLottery() {
  ...
  _proto.getAllLotteriesIds = function getAllLotteriesIds() {
    var _this27 = this;
...
function FetchChain(methodName, objectIds, timeout) {
  if (timeout === void 0) {
    timeout = 1900;
  }
